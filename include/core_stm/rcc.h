...
//        Calibration
#define RCC_CR_HSICAL(n)  (((n)&0xFF) << 8)   // (r)  (X)
#define RCC_CR_HSITRIM(n) (((n)&0x1F) << 3)   // (rw) (0x10)
    uint32_t CR;
...
#define RCC_CFGR_MCO(n)      (((n)&0x3) << 24)
//        Prescalar (rw) (0)
#define RCC_CFGR_USBPRE    (1 << 22)
#define RCC_CFGR_ADCPRE(n) (((n)&0x3) << 14)
#define RCC_CFGR_PPRE2(n)  (((n)&0x7) << 11)
#define RCC_CFGR_PPRE1(n)  (((n)&0x7) << 8)
#define RCC_CFGR_HPRE(n)   (((n)&0xF) << 4)
//        PLL (0)
#define RCC_CFGR_PLLMUL(n) (((n)&0xF) << 18)  // (r)
#define RCC_CFGR_PLLXTPRE (1 << 17)           // (rw)
#define RCC_CFGR_PLLSRC   (1 << 16)           // (rw)
//        System clock switch (0)
#define RCC_CFGR_SWS(n)   (((n)&0x3) << 2)    // (r)
#define RCC_CFGR_SW(n)    (((n)&0x3) << 0)    // (rw)
    uint32_t CFGR;
...
#define RCC_BDCR_RTCSEL(n)    (((n)&0x3) << 8)
//        Backup Reset (rw) (0)
