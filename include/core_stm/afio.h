...
#define AFIO_PORT(n)  (((n)&0x7) << 4)
    //        PIN[3:0] (Pin selection (x=A..E))
#define AFIO_PIN(n)   (((n)&0xF) << 0)
    uint32_t EVCR;
...
#define AFIO_MAPR_CFG(n)  (((n)&0x7) << 24)
    //        ADC Remapping: (0)
...
#define AFIO_MAPR_TIM3_REMAP(n)       (((n)&0x3) << 10)
#define AFIO_MAPR_TIM2_REMAP(n)       (((n)&0x3) << 8)
#define AFIO_MAPR_TIM1_REMAP(n)       (((n)&0x3) << 6)
...
#define AFIO_MAPR_CAN_REMAP(n)        (((n)&0x3) << 13)
#define AFIO_MAPR_USART3_REMAP(n)     (((n)&0x3) << 4)
...
#define AFIO_EXTICR1_EXTI(x, n)   (((n)&0xF) << ((x)&0x3)*4)
    uint32_t EXTICR1;
...
#define AFIO_EXTICR2_EXTI(x, n)   (((n)&0xF) << ((x)&0x3)*4)
    uint32_t EXTICR2;
...
#define AFIO_EXTICR3_EXTI(x, n)   (((n)&0xF) << ((x)&0x3)*4)
    uint32_t EXTICR3;
...
#define AFIO_EXTICR4_EXTI(x, n)   (((n)&0xF) << ((x)&0x3)*4)
    uint32_t EXTICR4;
...
#define AFIO_MAPR2_TIM12_REMAP  (1 << 7)
